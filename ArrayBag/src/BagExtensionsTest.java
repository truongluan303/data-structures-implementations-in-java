...
public class BagExtensionsTest {
    ...
    private static ArrayBag<String> testBag1 = new ArrayBag<>();
    private static ArrayBag<String> testBag2 = new ArrayBag<>();
    private static ArrayBag<String> testBag3 = new ArrayBag<>();
    private static ArrayBag<String> testBag4 = new ArrayBag<>();
    private static ArrayBag<String> testBag5 = new ArrayBag<>();
    private static ArrayBag<String> testBag6 = new ArrayBag<>();
    private static ArrayBag<String> testBag7 = new ArrayBag<>();
    private static ArrayBag<String> testBag8 = new ArrayBag<>();
    private static ArrayBag<String> testBag9 = new ArrayBag<>();
    private static ArrayBag<String> testBag10 = new ArrayBag<>();
    private static ArrayBag<String> testBag11 = new ArrayBag<>(35);
    private static ArrayBag<String> testBag12 = new ArrayBag<>(35);
    private static ArrayBag<String> testBag13 = new ArrayBag<>();
    private static ArrayBag<String> testBag14 = new ArrayBag<>();
    private static ArrayBag<String> testBag15 = new ArrayBag<>();
    private static ArrayBag<String> testBag16 = new ArrayBag<>();
    private static ArrayBag<String> testBag17 = new ArrayBag<>();
    private static ArrayBag<String> testBag18 = new ArrayBag<>();
    private static ArrayBag<String> testBag19 = new ArrayBag<>();
    private static ArrayBag<String> testBag20 = new ArrayBag<>();
    private static ArrayBag<String> testBag21 = new ArrayBag<>();
    private static ArrayBag<String> testBag22 = new ArrayBag<>();
    private static ArrayBag<String> testBag23 = new ArrayBag<>();
    private static ArrayBag<String> testBag24 = new ArrayBag<>();
    private static ArrayBag<String> testBag25 = new ArrayBag<>(10);
    private static ArrayBag<String> testBag26 = new ArrayBag<>(10);
    private static ArrayBag<String> testBag27 = new ArrayBag<>(10);
    private static ArrayBag<String> testBag28 = new ArrayBag<>(10);
    private static ArrayBag<String> testBag29 = new ArrayBag<>(10);
    private static ArrayBag<String> testBag30 = new ArrayBag<>(10);
    private static ArrayBag<String> testBag31 = new ArrayBag<>();
    private static ArrayBag<String> testBag32 = new ArrayBag<>();
    private static ArrayBag<String> testBag33 = new ArrayBag<>();
    private static ArrayBag<String> testBag34 = new ArrayBag<>();
    private static ArrayBag<String> testBag35 = new ArrayBag<>(50);
    private static ArrayBag<String> testBag36 = new ArrayBag<>();
    private static ArrayBag<String> testBag37 = new ArrayBag<>(50);
...
// A bag with two duplicates
    ...
    public static void checkRemove() {
       ...
       System.out.println();
        ...
        // Try removing items from a bag one at a time and verify that the size decreases correctly each time
    ...
    public static void checkRemoveDuplicates() {
       ...
       System.out.println();
        ...
        System.out.println("Checking to see a bag of two duplicates successfully becomes the correct singleton bag");
       ...
       System.out.println();
        ...
        System.out.println("Checking to see a bag of three duplicates successfully becomes the correct singleton bag");
       ...
       System.out.println();
        ...
        // Check that it works on a bag where some times are duplicated
       ...
       System.out.println();
        ...
        // Check that it works on a bag where every time is duplicated
