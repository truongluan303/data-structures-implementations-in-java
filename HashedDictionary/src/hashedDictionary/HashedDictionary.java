...
// -------------------------
// this method is used to display the hash table for illustration and testing
// -------------------------
    ...
    public void displayHashTable() {
        ...
        for (TableEntry<K, V> kvTableEntry : hashTable) {
            ...
            else if (kvTableEntry.isRemoved())
                System.out.println("removed state");

            else
                System.out.println(kvTableEntry.getKey() + " " + kvTableEntry.getValue());
        } // end for
        System.out.println();
