...
public class HashedDictionaryOpenAddressingPerfectInstrumented<K,V> implements DictionaryInterface<K,V>
{
    ...
    private Random getHashGenerator(K key) {
    ...
    private int locate(Random rand, K key)
    {
        ...
        // determine the first location to look in
        ...
        while ( !found && (hashTable[index] != null) )
        {
            if ( hashTable[index].isIn() &&
                ...
                index = rand.nextInt(hashTable.length); // perfect probing
                totalProbes++; // increase the probe times by 1
            }
        } // end while
